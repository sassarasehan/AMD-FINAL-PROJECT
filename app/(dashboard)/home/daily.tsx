...
const styles = StyleSheet.create({
  ...
  // Updated styles for swipe actions
  // Updated styles for swipe actions
  actionsContainer: {
    flexDirection: "row",
    height: 90, // Match the minHeight of transactionCard
    width: 180,
    borderRadius: 16, // Match the card border radius
    overflow: 'hidden', // Ensure rounded corners are respected
  },
  updateAction: {
    alignItems: "center",
    justifyContent: "center",
    width: 90, // Equal width for both buttons
    backgroundColor: "transparent",
    height: 100, // Explicit height to match card
  },
  deleteAction: {
    alignItems: "center",
    justifyContent: "center",
